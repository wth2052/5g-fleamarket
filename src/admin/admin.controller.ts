...
export class AdminController {
  ...
  //카테고리 수정 API
  @Put('/api/category/:id')
  @ApiOperation({ summary: '카테고리 수정', description: '카테고리를 수정함' })
  ...
  @ApiUnauthorizedResponse({
    description: '존재하는 관리자가 아니여서 공지 생성을 할 수 없음',
  })
  ...
  @ApiOperation({ summary: '공지사항 수정', description: '공지사항를 수정함' })
  @ApiCreatedResponse({ description: '공지사항 제목이나 내용이 수정됨' })
  @ApiNotFoundResponse({
    description: '공지사항 제목이나 내용 입력란이 비어있음',
  })
  @ApiParam({ name: 'noticeId', type: Number, description: '공지 Id' })
  ...
  @ApiOperation({ summary: '공지 삭제', description: '공지를 완전히 삭제함' })
  ...
  @ApiOperation({ summary: '신고 삭제', description: '신고를 완전히 삭제함' })
